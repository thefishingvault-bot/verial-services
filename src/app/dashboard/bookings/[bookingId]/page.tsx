...
async function loadBooking(
  ...
  const typedReschedules: LoadedBooking["reschedules"] = reschedules.map(
    (reschedule): LoadedBooking["reschedules"][number] => ({
      ...reschedule,
      status: reschedule.status as LoadedBooking["reschedules"][number]["status"],
    }),
  );
