...
type ReviewListItem = {
  ...
  provider: { id: string | null; businessName: string | null } | null;
  service: { id: string | null; title: string | null; slug: string | null } | null;
};
...
export default async function ReviewsPage() {
  ...
  const items = (await db
    ...
    .orderBy(desc(reviews.createdAt))) satisfies ReviewListItem[];
